...
while read -r t; do
    ...
    while read -r s; do
    	...
    	if $doBulleting ; then
            ...
            # Generate Animation
    	    convert -delay 25 -loop 0 ../usr/$1/output/target_${targetcount}_source_${sourcecount}/bulletin*.png ../usr/$1/output/target_${targetcount}_source_${sourcecount}/bulletin.gif
	    else
	        echo "-->Skipped"
        fi
