...
cd PreProcessing
python forcoast_download_yml.py -a eforie -T 2021-11-01 -p 5 -d c:\data
cd ..

:: Run model (uses data directory from command line, such that we don't need to change the yaml file for testing)
cd Processing
python forcoast.py -y eforie -T 2021-11-01 -p 5 -s [28.6803,44.2201,0.5] -d c:\data\
cd ..
...
:: Run bulletin script
cd BulletinScript
python bulletin_script.py -y eforie -s [28.6803,44.2201] -c 1 -t [[28.6611,44.0435],[28.67,44.0435],[28.67,44.0553],[28.6611,44.0553]] -T 2021-09-20 -k 0 -d c:\data
cd ..