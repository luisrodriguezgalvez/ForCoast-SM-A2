...
cd Processing
python forcoast.py -y galway -T 2021-11-01 -p 5 -s [28.6803,44.2201,0.5] -d c:\data\
cd ..
...
cd PostProcessing
python SM-A2-Postprocess.py -y galway -s [28.6803,44.2201] -c 1 -t [[-9.0175,53.16816958],[-9.041166667,53.16817019],[-9.042,53.18817033],[-9.018833333,53.18816981]] -k 0 -d c:\data 
cd ..

:: Run bulletin script
cd BulletinScript
python bulletin_script.py -y galway -s [28.6803,44.2201] -c 1 -t [[-9.0175,53.16816958],[-9.041166667,53.16817019],[-9.042,53.18817033],[-9.018833333,53.18816981]] -T 2021-09-20 -k 0 -d c:\data
cd ..
